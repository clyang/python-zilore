...
class Api(object):
    ...
    def add_failover_record(self, domain_name='', record_id=None, failover_check_type='', failover_check_interval='', failover_return_to_main_value='', failover_additional_path='', failover_additional_port='', failover_record_backup_value=[], failover_use_fws='', failover_additional_response='', failover_additional_request='', failover_notification_email='', failover_notification_sms=''):
        backup_value_str = ''
    ...
    def update_failover_record(self, domain_name='', record_id=None, failover_check_type='', failover_check_interval='', failover_return_to_main_value='', failover_additional_path='',failover_additional_port='', failover_record_backup_value=[], failover_use_fws='', failover_additional_response='', failover_additional_request='', failover_notification_email='', failover_notification_sms=''):
        backup_value_str = ''
        if isinstance(failover_record_backup_value, list) and failover_record_backup_value:
            max_val = min(len(failover_record_backup_value) ,3)
            for i in range(max_val):
